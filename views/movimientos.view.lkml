...
dimension: Mes {
  ...
  type: string
  sql: TRANSLATE(UPPER(DATENAME(month, IFNULL(${TABLE}.Fecha, GETDATE()))), 'JANUARYFEBRUARYMARCHAPRILMAYJUNEJULYAUGUSTSEPTEMBEROCTOBERNOVEMBERDECEMBER', 'ENEROFEBREROMARZOABRILMAYOJUNIOJULIOAGOSTOSEPTIEMBREOCTUBRENOVIEMBREDICIEMBRE') ;;
}
