...
dimension_group: Fecha {
  ...
  dimension: Mes {
    type: string
    sql: UPPER(TRANSLATE(DATENAME(month, IFNULL(${TABLE}.Fecha, GETDATE())), 'JANUARYFEBRUARYMARCHAPRILMAYJUNEJULYAUGUSTSEPTEMBEROCTOBERNOVEMBERDECEMBER', 'ENEROFEBREROMARZOABRILMAYOJUNIOJULIOAGOSTOSEPTIEMBREOCTUBRENOVIEMBREDICIEMBRE')) ;;
  }
